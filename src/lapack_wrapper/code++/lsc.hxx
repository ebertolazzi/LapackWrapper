...
namespace lapack_wrapper {
  ...
  public:
    ...
    factorize(
      ...
      LW_ERROR0("LSC::factorize, virtual one not defined!");
    }
    ...
    bool
    t_solve( valueType [] ) const LAPACK_WRAPPER_OVERRIDE {
      LW_ERROR0("LSC::t_solve not defined!");
    }
