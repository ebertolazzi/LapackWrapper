...
/*!
 * \file trid.hxx
 * \brief Direct solvers for scalar tridiagonal systems.
 *
 * The implementations cover symmetric positive definite, generic LU, and QR
 * based least-squares variants for matrices described by their three bands.
 */
...
namespace lapack_wrapper {
  ...
  /*!
   * \brief Solver for symmetric positive definite tridiagonal systems.
   *
   * The factorization is based on the LAPACK positive-definite tridiagonal
   * routines and supports multiple right-hand sides.
   */
  template <typename T>
  ...
  /*!
   * \brief LU-based solver for a generic tridiagonal matrix.
   *
   * The factorization stores the modified three bands together with the extra
   * second superdiagonal generated by pivoting.
   */
  template <typename T>
  ...
  \*/
  /*!
   * \brief QR-based solver for tridiagonal least-squares problems.
   *
   * Besides direct solve routines, the class exposes helpers for regularized
   * least-squares through the `lsq()` method.
   */
  template <typename T>
