...
#include "hqrrp/NoFLA_HQRRP_WY_blk_var4.hh"
...
static void print_double_matrix( char const * name, int m_A, int n_A,
                double * buff_A, int ldim_A );

static void print_double_vector( char const * name, int n, double * vector );

static void print_int_vector( char const * name, int n, int * vector );
...
int main( int argc, char *argv[] ) {
  ...
  // New factorization.
  lapack_wrapper::dgeqp4(
    m_A, n_A, buff_A, ldim_A, buff_p, buff_tau,
  ...
  lapack_wrapper::gecopy( m_A, mn_A, buff_A, ldim_A, buff_Q, ldim_Q );
...
// ============================================================================
static void print_double_vector( char const * name, int n_v, double * buff_v ) {
  printf( "%s = [\n", name );
  for( int i = 0; i < n_v; i++ ) {
    printf( "%le\n", buff_v[ i ] );
  }
...
// ============================================================================
static void print_int_vector( char const * name, int n_v, int * buff_v ) {
  printf( "%s = [\n", name );
  for( int i = 0; i < n_v; i++ ) {
    printf( "%d\n", buff_v[ i ] );
  }
